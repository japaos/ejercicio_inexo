<?php
    ...
    {  
        if($_POST['proceso']=='proceso'){
            //liberacion de consultas
            $liberar = "UPDATE `consulta` SET estado= 'libre' ";
            $hecho = mysqli_query($conexion, $liberar);

            //REASIGNACION DE CONSULTAS POR ESTANDAR
